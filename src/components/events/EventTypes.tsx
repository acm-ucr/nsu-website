...
const EventTypes = () => (
  <div className="w-screen overflow-x-hidden px-0">
    <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
      <div className="order-1 mb-6 -ml-4 w-full md:mr-6 md:mb-0">
        <div
      ...
      <div className="order-2 md:row-span-2">
        <div className="relative mx-16 flex w-auto justify-center">
          <Image
            src={BigLittle}
            alt="Big Little Reveal Shadow"
            className="translate-x-2 translate-y-2 rounded-lg opacity-50 md:translate-x-4 md:translate-y-4"
          />
          <Image
            src={BigLittle}
            alt="Big Little Reveal"
            className="absolute z-10 rounded-lg"
          />
        </div>
      </div>

      <p className="text-urbanist order-3 mx-10 py-7 text-center text-xl/8 tracking-wide md:ml-10 md:w-9/10 md:py-10 md:text-2xl/8 lg:w-9/10 lg:text-start lg:text-3xl/14 xl:ml-20 xl:text-4xl/14">
        Join our Big Little program and become part of the UCR NSU family! Bigs
        serve as mentors and friends, while Littles get the opportunity to
        connect and grow within the club. It's the perfect way to meet new
        people and build lasting friendships!
      </p>
    </div>

    <div className="grid grid-cols-1 gap-5 py-8 lg:grid-cols-2 lg:py-4">
      <div className="order-2 md:row-span-2 lg:order-1">
        <div className="relative mx-16 flex justify-center">
          <Image
            src={RetreatImg}
            alt="Winter Retreat Shadow"
            className="translate-x-2 translate-y-2 rounded-lg opacity-50 md:translate-x-4 md:translate-y-4"
          />
          <Image
            src={RetreatImg}
      ...
      <p className="text-urbanist order-3 mx-10 py-7 text-center text-xl/8 tracking-wide md:w-9/10 md:py-10 md:text-2xl/8 lg:w-9/10 lg:text-end lg:text-3xl/14 xl:text-4xl/14">
        Escape to the mountains in Big Bear for a fun-filled weekend at our
        annual Winter Retreat! Enjoy bonding with friends over food, games, and
        cozy vibes. Hit the slopes for some snowboarding or skiing, or just
        relax and take in the winter scenery. Don’t miss out on this
