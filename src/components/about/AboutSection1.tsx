  ...
  return (
    ...
    <div className="px-4 md:px-6">
      <motion.div
        ...
        className="bg-nsu-red-200 mx-auto my-2 h-[4px] w-full md:w-1/2"
      ></motion.div>
      <motion.div
      ...
      >
        <div>
          <p className="font-nsu-main text-nsu-gray-300 mt-5 w-full text-center text-xl leading-7 tracking-normal md:w-3/4 md:text-left md:text-3xl md:leading-9">
            Nikkei Student Union (NSU) is a socio-cultural organization devoted
            to promoting, preserving, and educating the surrounding community
            and college-aged youth about the history of Japanese and Japanese
