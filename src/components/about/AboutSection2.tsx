  ...
  return (
    <section className="bg-nsu-tan-100 relative flex flex-col items-start p-8 py-16">
      <div className="ml-auto w-3/4 text-right">
        <div className="bg-nsu-red-200 my-2 ml-auto h-[4px] w-2/3"></div>
        <p className="font-nsu-main text-nsu-gray-300 mt-5 text-3xl leading-9 tracking-normal">
          We host bi-weekly General Meetings where our NSU community gathers to
          learn more about Japanese American Culture, participate in engaging
          games and icebreaker activities, as well as hear more about upcoming
          events open to General Members.
        </p>
      </div>
